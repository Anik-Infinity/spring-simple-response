...
public class BookManager {
    ...
    public BookDto create(CreateBookDto createBookDto) {
        ...
        return this.bookMapper.toDto(this.bookService.save(book), new CycleAvoidingMappingContext());
    }

    public BookDto getById(UUID id) {
        return this.bookMapper.toDto(this.bookService.getById(id), new CycleAvoidingMappingContext());
    }
    ...
    public Page<BookDto> getList(int pageNo, int pageSize, UUID authorId) {
        ...
        return books.map(book -> this.bookMapper.toDto(book, new CycleAvoidingMappingContext()));
    }
